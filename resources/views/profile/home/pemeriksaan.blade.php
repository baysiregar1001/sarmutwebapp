    ...
    <div class="container pt-16 pb-10">
        <div class="row px-4">
            <div class="col text-center mt-2">
                <h1 class="text-uppercase text-success font-bold mb-3 pt-3">Ruangan General Check-Up</h1>
...
<section id="fotopemeriksaan">
    <div class="container x-auto px-4 mb-7 pb-10">
        <div class="grid grid-cols-12">
            {{-- Foto Ruangan General Check-Up --}}
