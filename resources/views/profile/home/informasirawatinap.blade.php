...
<section id="informasirawatinap">
    <div class="container pt-16 pb-10">
        <div class="row px-4">
            <div class="col text-center mt-2">
                <h1 class="text-uppercase text-success font-bold mb-3 pt-3">Informasi Pendaftaran Rawat Inap</h1>
...
<section id="fotoruangrawat">
    <div class="container x-auto px-4 mb-7 pb-10">
        <div class="grid grid-cols-12">
            {{-- Foto Informasi Pendaftaran Rawat Inap --}}
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a href=""><img src="/img/gambar/rawatinap/1.svg" class="d-block w-100" alt="..."></a>
