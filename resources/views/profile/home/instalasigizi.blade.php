...
<section id="instalasigizi">
    <div class="container pt-16 pb-10">
        <div class="row px-4">
            <div class="col text-center mt-2">
                <h1 class="text-uppercase text-success font-bold mb-3 pt-3">Ruangan Instalasi Gizi</h1>
                <h2 class="font-bold text-4xl mb-2">RSU <span class="text-green-600">Sari Mutiara</span>
                    Lubuk Pakam</h2>
            </div>
        </div>
    </div>
