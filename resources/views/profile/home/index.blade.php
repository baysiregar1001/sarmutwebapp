        ...
        <div class="grid grid-cols-12">
            ...
            <div class="col-span-12 lg:col-span-4 order-2">
                ...
                <div class="lg:my-10 align center">
                    ...
                    <img class="img-fluid mx-auto d-block mb-3" src="{{ URL::asset('/img/logo/logo-sarmut.png') }}" alt="profile Pic" height="100" width="100">
                    ...
                    <ul class="flex gap-2 justify-center">
                        <li class="">
                            {{-- FACEBOOK --}}
                            <a href="https://www.facebook.com/profile.php?id=100063789413668" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-slate-300 border border-slate-300 hover:border-green-600 hover:bg-green-600 hover:text-white">
                        ...
                        <li class="">
                            {{-- INSTAGRAM --}}
                            <a href="https://www.instagram.com/rsu.sari_mutiara_lubuk_pakam" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-slate-300 border border-slate-300 hover:border-green-600 hover:bg-green-600 hover:text-white">
                                <svg role="img" width=20 class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-span-12 lg:col-span-8 order-1 mb-5">
                {{-- GAMBAR HERO SECTION --}}
                <div>
                    <img src="/img/gambar/sarmut-gambar.png" alt="" class="rounded-lg img-fluid" height="750" width="750">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="w-full px-4">
            <div class="flex flex-wrap items-center justify-center">
                <a href="#" class="max-w-[150px] mx-4 py-4 grayscale opacity-60 transition duration-500 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8">
                    <img src="img/clients/bpjs.svg" alt="BPJS">
                </a>
                <a href="#" class="max-w-[150px] mx-4 py-4 grayscale opacity-60 transition duration-500 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8">
                    <img src="img/clients/halodoc.svg" alt="Halodoc">
                </a>
                <a href="#" class="max-w-[240px] mx-4 py-4 grayscale opacity-60 transition duration-500 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8">
                    <img src="img/clients/alodokter.svg" alt="Alodokter">
                </a>
                <a href="#" class="max-w-[100px] mx-4 py-4 grayscale opacity-60 transition duration-500 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8">
        ...
        <form>
            ...
            <div class="w-full lg:w-2/3 lg:mx-auto">
                ...
                <div class="w-full px-4 mb-8">
                    ...
                    <input type="text" id="name" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-green-600 focus:ring-1 focus:border-green-600">
                </div>
                {{-- ISIAN EMAIL --}}
                <div class="w-full px-4 mb-8">
                    <label for="message" class="text-base text-green-600 font-bold mb-1">Email</label>
                    <input type="text" id="email" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-green-600 focus:ring-1 focus:border-green-600">
                </div>
                {{-- ISIAN PESAN --}}
                <div class="w-full px-4 mb-8">
                    <label for="message" class="text-base text-green-600 font-bold mb-1">Pesan</label>
                    <textarea type="text" id="email" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-green-600 focus:ring-1 focus:border-green-600 h-32"></textarea>
                </div>
                {{-- BUTTON KIRIM --}}
                <div class="w-full px-4 mb-8">
                    <button class="text-base font-semibold text-white bg-green-600 py-3 px-8 rounded-full w-full hover:opacity-80 hover:shadow-lg transition duration-500">Kirim</button>
                </div>
            </div>
        </form>
    </div>
